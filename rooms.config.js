...
ROOMS_APP.SHEET_NAMES = {
  ...
  TIMETABLE_DOCENTI_SOSTEGNO: 'ORARIO_DOCENTI_SOSTEGNO',
  TIMETABLE_SPACES_RAW: 'TIMETABLE_SPACES_RAW',
  AULA_MAGNA_EVENTS: 'ROOMS_AULA_MAGNA_EVENTS',
  REPL_CLASS_OUT: 'REPL_CLASS_OUT',
  REPL_DAY_TEACHERS: 'REPL_DAY_TEACHERS',
  REPL_FIELD_TRIPS: 'REPL_FIELD_TRIPS',
  REPL_FIELD_TRIP_TEACHERS: 'REPL_FIELD_TRIP_TEACHERS',
  REPL_ABSENCES: 'REPL_ABSENCES',
  REPL_HOURLY_ABSENCES: 'REPL_HOURLY_ABSENCES',
  REPL_ASSIGNMENTS: 'REPL_ASSIGNMENTS',
  REPL_LONG_ASSIGNMENTS: 'REPL_LONG_ASSIGNMENTS',
  REPL_DAILY_CACHE: 'REPL_DAILY_CACHE',
