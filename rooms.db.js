...
ROOMS_APP.DB = {
  STATIC_SHEET_CACHE_TTLS_: (function () {
    ...
    ttls[ROOMS_APP.SHEET_NAMES.LESSON_OVERRIDES] = 60;
    ...
    ttls[ROOMS_APP.SHEET_NAMES.REPL_FIELD_TRIPS] = 60;
    ttls[ROOMS_APP.SHEET_NAMES.REPL_FIELD_TRIP_TEACHERS] = 60;
    ttls[ROOMS_APP.SHEET_NAMES.REPL_ABSENCES] = 60;
    ttls[ROOMS_APP.SHEET_NAMES.REPL_HOURLY_ABSENCES] = 60;
    ...
    ttls[ROOMS_APP.SHEET_NAMES.REPORT_ARCHIVE] = 120;
    ttls[ROOMS_APP.SHEET_NAMES.REPORT_ARCHIVE_HISTORY] = 120;
    return ttls;
  }()),
